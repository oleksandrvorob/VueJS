    ...
    <div>
        <div class="footerads tds-footer-grid" v-if="!loaded">
            <div class="tds-mini-jumbotron">
                <div class="tds-footer-trans"></div>
            </div>
        ...
        <div v-if="loaded"  class="desktop-large">
            <img  :src="baseUrl+desktop" @click="visit()" class="promo-link">
        </div>
        <div>
...
export default {
    ...
    methods:{
        ...
        getBanner(){
            this.$store.dispatch('promo/getBanners', "LARGE")
        },
        visit(){
        ...
        TimerFunction(){
            ...
            if(this.counter >= this.large.length){
                this.counter = 0
            }

            this.desktop = this.large[this.counter].desktop
            this.mobile = this.large[this.counter].mobile
            this.url = this.large[this.counter].url
        }
    },
    computed: {
        loaded() {
        ...
        large(){
            return this.$store.state.promo.large
        }
    },
    created(){
        this.getBanner()
