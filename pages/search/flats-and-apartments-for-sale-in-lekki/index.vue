<template>
  <section class="searchParams">
    <header class="tds-titles" align="center">
      <strong>Flats and Apartments for sale in </strong>Lekki
      <hr>
    </header>
    <div>
...
export default {
  ...
  data() {
    return {
      property:'',
      title: 'Flats and Apartments for sale in Lekki - 2Dots Properties',
      location:'Lekki',
      type:"flats",
      purpose:'sale',
      total: 0,
      ...
      isRounded: false,
      queryParam: {},
      url:'q/search?q=Lekki&purpose=SALE&type_of_property=FLAT%20OR%20APARTMENT'
    }
  },
  methods: {
    updateTopSpaces(m, p) {
