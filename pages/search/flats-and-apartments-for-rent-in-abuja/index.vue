...
export default {
  ...
  data() {
    return {
      property:'',
      title: 'Flats and Apartments for rent in Abuja - 2Dots Properties',
      location:'Abuja',
      type:"flats",
      purpose:'sale',
      total: 0,
      ...
      isRounded: false,
      queryParam: {},
      url:'q/search?q=abuja&purpose=RENT&type_of_property=FLAT%20OR%20APARTMENT'
    }
  },
  methods: {
    updateTopSpaces(m, p) {
