...
export default {
  ...
  data() {
    return {
       property:'',
      title: 'Houses for Rent in Lagos - 2Dots Properties',
      total: 0,
      current: 1,
      perPage: 0,
      order: 'is-centered',
      ...
      isRounded: false,
      queryParam: {},
      url:'q/search?q=lagos&type_of_property=HOUSE&purpose=RENT'
    }
  },
  methods: {
    updateTopSpaces(m, p) {
