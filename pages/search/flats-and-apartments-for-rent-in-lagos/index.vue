<template>
  <section class="searchParams">
    <header class="tds-titles" align="center">
      <strong>Flats and Apartments for rent in </strong>Lagos
      <hr>
    </header>
    <div>
      <div class="column is-full tds-column-grey">
        <div>There are <span id="total_property">{{ property !== "" ? property : 500 }}</span> flats and apartments 
...
export default {
  ...
  data() {
    return {
      property:'',
      title: 'Properties for rent in Lagos - 2Dots Properties',
      total: 0,
      current: 1,
      perPage: 0,
      order: 'is-centered',
