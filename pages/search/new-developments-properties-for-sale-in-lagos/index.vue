<template>
  <section class="searchParams">
    <header class="tds-titles" align="center">
      <strong>New Development Properties for sale in </strong> Lagos
      <hr>
    </header>
    <div>
      <div class="column is-full tds-column-grey">
        <div>There are <span id="total_property">{{ property !== "" ? property : 500 }}</span> New Developments Properties 
...
export default {
  ...
  data() {
    return {
      property:'',
      title: 'New Developments Properties for sale in Lagos - 2Dots Properties',
      location:'Lagos',
      type:"new developements",
      purpose:'sale',
      total: 0,
      current: 1,
      perPage: 0,
      ...
      isRounded: false,
      queryParam: {},
      url:'q/search?q=Lagos&purpose=NEW'
    }
  },
  methods: {
    updateTopSpaces(m, p) {
