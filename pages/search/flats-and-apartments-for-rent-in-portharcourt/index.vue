<template>
  <section class="searchParams">
    <header class="tds-titles" align="center">
      <strong>Flats and Apartments for rent in </strong>Port Harcourt
      <hr>
    </header>
    <div>
      <div class="column is-full tds-column-grey">
        <div>There are <span id="total_property">{{ property !== "" ? property : 500 }}</span> available flats
        listed for rent in Port Harcourt.
...
export default {
  ...
  data() {
    return {
      property:'',
      title: 'Flats and Apartments for rent in Port Harcourt - 2Dots Properties',
      total: 0,
      current: 1,
      perPage: 0,
      order: 'is-centered',
      ...
      isRounded: false,
      queryParam: {},
      url:"q/search?q=port%20harcourt&purpose=RENT&type_of_property=FLAT%20OR%20APARTMENT"
    }
  },
  methods: {
    updateTopSpaces(m, p) {
