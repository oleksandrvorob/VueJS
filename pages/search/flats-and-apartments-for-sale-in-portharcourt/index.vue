<template>
  <section class="searchParams">
    <header class="tds-titles" align="center">
      <strong>Flats and apartments for sale in </strong> Port Harcourt
      <hr>
    </header>
    <div>
...
export default {
  ...
  data() {
    return {
      property:'',
      title: 'Flats and Apartments for sale in Port Harcourt - 2Dots Properties',
      total: 0,
      current: 1,
      perPage: 0,
      order: 'is-centered',
      ...
      isRounded: false,
      queryParam: {},
      url:"q/search?q=port%20harcourt&purpose=SALE&type_of_property=FLAT%20OR%20APARTMENT"
    }
  },
  methods: {
    updateTopSpaces(m, p) {
