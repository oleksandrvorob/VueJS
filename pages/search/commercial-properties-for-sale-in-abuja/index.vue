<template>
  <section class="searchParams">
    <header class="tds-titles" align="center">
      <strong>Commercial Properties for sale in</strong> Abuja
      <hr>
    </header>
    <div>
...
export default {
  ...
  data() {
    return {
      property:'',
      title: 'Commercial Properties for sale in Abuja - 2Dots Properties',
      location:'Abuja',
      ...
      isRounded: false,
      queryParam: {},
      url:"q/search?q=abuja&purpose=SALE&type_of_property=COMMERCIAL"
    }
  },
  methods: {
    updateTopSpaces(m, p) {
