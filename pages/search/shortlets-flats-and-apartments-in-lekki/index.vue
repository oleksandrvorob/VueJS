<template>
  <section class="searchParams">
    <header class="tds-titles" align="center">
      <strong>Shortlets, Flats and Apartments in </strong>Lekki
      <hr>
    </header>
    <div>
      <div class="column is-full tds-column-grey">
        <div>There are <span id="total_property">{{ property !== "" ? property : 500 }}</span> available shortlets, flats and apartments
        listed for sale in Lekki.
...
export default {
  ...
  data() {
    return {
      property:'',
      title: 'Shortlets Flats and Apartments in Lekki - 2Dots Properties',
      location:'Lekki',
      type:"flats",
      purpose:'shortlets',
      total: 0,
      ...
      isRounded: false,
      queryParam: {},
      url:'q/search?q=Lekki&purpose=SHORT&type_of_property=FLAT%20OR%20APARTMENT'
    }
  },
  methods: {
    updateTopSpaces(m, p) {
