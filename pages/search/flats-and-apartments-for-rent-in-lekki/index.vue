<template>
  <section class="searchParams">
    <header class="tds-titles" align="center">
      <strong>Flats and Apartments for rent in </strong> Lekki
      <hr>
    </header>
    <div>
      <div class="column is-full tds-column-grey">
        <div>There are <span id="total_property">{{ property !== "" ? property : 500 }}</span> available flats, houses, land and commercial property 
        listed for rent in lekki.
...
export default {
  ...
  data() {
    return {
      property:'',
      title: 'Flats and Apartments for rent in Lekki - 2Dots Properties',
      location:'Nigeria',
      type:"flats",
      purpose:'rent',
      total: 0,
      ...
      isRounded: false,
      queryParam: {},
      url:'q/search?q=Lekki&purpose=RENT&type_of_property=FLAT%20OR%20APARTMENT'
    }
  },
  methods: {
    updateTopSpaces(m, p) {
