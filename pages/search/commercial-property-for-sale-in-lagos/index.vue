<template>
  <section class="searchParams">
    <header class="tds-titles" align="center">
      <strong>Commercial Properties for sale in  </strong>Lagos
      <hr>
    </header>
    <div>
...
export default {
  ...
  data() {
    return {
      property:'',
      title: 'Commercial Properties For Sale in Lagos - 2Dots Properties',
      location:'Lagos',
      ...
      isRounded: false,
      queryParam: {},
      url:'q/search?q=lagos&type_of_property=COMMERCIAL&purpose=SALE'
    }
  },
  methods: {
    updateTopSpaces(m, p) {
