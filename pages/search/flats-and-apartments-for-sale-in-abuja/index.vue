<template>
  <section class="searchParams">
    <header class="tds-titles" align="center">
      <strong>Flats and Apartments for sale in </strong>Abuja
      <hr />
    </header>
    <div>
      <div class="column is-full tds-column-grey">
        <div>
          There are
          <span id="total_property">{{ property !== "" ? property : 500 }}</span> available flats
          listed for sale in Abuja.
          These properties have been listed by verified estate agents,
          property owners, and estate developers who you can contact
          using their contact details provided for each property listing.
        </div>
      </div>
...
export default {
  ...
  data() {
    return {
      property: '',
      title: 'Flats and Apartments for sale in Abuja - 2Dots Properties',
      location: 'Abuja',
      type: 'flats',
      purpose: 'sale',
      total: 0,
      ...
      queryParam: {},
      url:
        'q/search?q=abuja&purpose=SALE&type_of_property=FLAT%20OR%20APARTMENT'
    }
  },
  methods: {
    updateTopSpaces(m, p) {
