<template>
  <section class="searchParams">
    <header class="tds-titles" align="center">
      <strong> Flats and Apartments for Sale in </strong>Lagos
      <hr>
    </header>
    <div>
      <div class="column is-full tds-column-grey">
        <div>There are <span id="total_property">{{ property !== "" ? property : 500 }}</span> available flats and apartments 
...
export default {
  ...
  data() {
    return {
      property:'',
      title: 'Flats and Apartments for sale in Lagos - 2Dots Properties',
      total: 0,
      current: 1,
      perPage: 0,
      order: 'is-centered',
      ...
      isRounded: false,
      queryParam: {},
      url:'q/search?q=lagos&type_of_property=FLAT%20OR%20APARTMENT&purpose=SALE'
    }
  },
  methods: {
    updateTopSpaces(m, p) {
