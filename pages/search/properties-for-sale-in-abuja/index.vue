<template>
  <section class="searchParams">
    <header class="tds-titles" align="center">
      <strong> Properties for sale in </strong>Abuja
      <hr>
    </header>
    <div>
...
export default {
  ...
  data() {
    return {
      property:'',
      title: ' Properties for sale in Abuja - 2Dots Properties',
      location:'Abuja',
      type:"flats, houses, land and commercial property",
      purpose:'sale',
      total: 0,
      current: 1,
      perPage: 0,
      ...
      isRounded: false,
      queryParam: {},
      url:'q/search?q=abuja&purpose=SALE'
    }
  },
  methods: {
    updateTopSpaces(m, p) {
